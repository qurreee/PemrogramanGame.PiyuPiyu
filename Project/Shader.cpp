...
Engine::Shader* Engine::Shader::setInt(int i, string str)
{
	glUniform1i(glGetUniformLocation(programId, str.c_str()), i);
	return this;
}

Engine::Shader* Engine::Shader::setFloat(float i, string str)
{
	glUniform1f(glGetUniformLocation(programId, str.c_str()), i);
	return this;
}

Engine::Shader* Engine::Shader::setMat4(mat4 mat, string str)
{
	glUniformMatrix4fv(glGetUniformLocation(programId, str.c_str()), 1, GL_FALSE, value_ptr(mat));
	return this;
}

Engine::Shader* Engine::Shader::setVec3(vec3 data, string str)
{
